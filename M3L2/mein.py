...
@app.route("/")
def titullist():
    return"<h1>Привет, тут ты можешь узнать интересные факты об технологической зависимости</h1><a href='/random_fact'>Посмотреть случайный факт!</a>"
@app.route("/random_fact")
def text():
    text_list = ["Большинство людей, страдающих технологической зависимостью, испытывают сильный стресс, когда они находятся вне зоны покрытия сети или не могут использовать свои устройства.",
